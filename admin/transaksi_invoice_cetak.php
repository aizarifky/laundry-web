...
<head>
    <title>Sistem Informasi Laundry Smart Tech Academy - aizarifky</title>
...
<body>
    ...
    <div class="container">
        <div class="col-md-10 col-md-offset-1">
            ...
            $transaksi = mysqli_query($koneksi, "select * from transaksi,pelanggan where transaksi_id='$id' and
            transaksi_pelanggan=pelanggan_id");
            while ($t = mysqli_fetch_array($transaksi)) {
            ?>
                <center>
                    <h2>LAUNDRY " aizarifky "</h2>
                </center>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            if ($t['transaksi_status'] == "0") {
                                ...
                                echo
                                "<div class='label label-info'>DI CUCI</div>";
